...
_The Google SignIn SDK is currently implemented using [AppAuth](https://appauth.io/). This will be changed in the future, as the Google SignIn SDK now supports the Swift Package Manager._
...
RxFireAuth targets **iOS 12.0 or later** and **macOS 10.13 or later** and has the following shared dependencies:
