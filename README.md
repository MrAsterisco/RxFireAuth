...
RxFireAuth is available through [CocoaPods](https://cocoapods.org) and [Swift Package Manager](https://swift.org/package-manager).

*If you are including this library in a project that needs to build for Apple Silicon, it is strongly recommended to use SPM.*
...
RxFireAuth targets **iOS 11.0 or later** and **macOS 10.12 or later** and has the following shared dependencies:

- `Firebase/Auth` version 8.
- `JWTDecode` version 2.
- `RxCocoa` version 6.
- `AppAuth` version 1.
